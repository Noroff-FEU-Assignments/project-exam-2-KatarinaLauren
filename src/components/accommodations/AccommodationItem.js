  ...
  return (
    <Link to={`detail/${id}`}>
      <Card className="flex-column flex-md-row align-items-center align-items-md-start accommodation__card m-auto mt-4">
        ...
        <Card.Body className="text-center text-md-start position-relative w-100 pb-4 mb-0 pt-md-0 mt-md-0">
          <Card.Text className={"card__text--rate fs-3 fst-normal p-2 mb-0"}>
            <span className="fst-italic fs-6">from </span>
            {rate},-
          </Card.Text>
          <Card.Title className="pt-3 pt-md-5 mt-md-3 text-center">{name}</Card.Title>
          <Card.Text className={"card__text--location pb-4 text-center"}>
